...
final class Version20211026182140 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'First base migration';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE discord_user (id UUID NOT NULL, discord_id VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN discord_user.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE transaction (id UUID NOT NULL, wallet_from_id UUID DEFAULT NULL, wallet_to_id UUID DEFAULT NULL, amount VARCHAR(255) NOT NULL, message TEXT DEFAULT NULL, type SMALLINT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE wallet (id UUID NOT NULL, discord_user_id UUID DEFAULT NULL, amount VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
